...
struct command {
	...
	{ "unload",   "Unconfigure all of the macvlan devices",	      do_unload,	 "Unconfigure all of the macvlan devices so module can be unloaded"},
	{ "setflags", "Set port flags on a port",			  do_setflags,
